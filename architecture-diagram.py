...
ax.text(9.4, 6.5, '💻', fontsize=16, ha='center', va='center')
...
ax.text(2.75, 9.2, '🛡️ Security & Firewall', fontsize=12, fontweight='bold', ha='center', color='white')
...
ax.text(2.75, 2.45, '🛡️ No Stored Keys', fontsize=9, fontweight='bold', ha='center', color='white')
